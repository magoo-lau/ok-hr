...
set JAVA_OPTS=%JAVA_OPTS% -Xmx2048m -Xms2048m -XX:MetaspaceSize=256m -XX:MaxMetaspaceSize=2048m -XX:MaxNewSize=896m -XX:NewSize=896m -XX:SurvivorRatio=6  -XX:-UseGCOverheadLimit -Djava.net.preferIPv4Stack=true -Dstart_scheduler=false
