...
set JAVA_OPTS=%JAVA_OPTS% -Xmx2048m -Xms2048m -XX:MetaspaceSize=256m -XX:MaxMetaspaceSize=2048m -XX:MaxNewSize=896m -XX:NewSize=896m -XX:SurvivorRatio=6  -XX:-UseGCOverheadLimit -Djava.net.preferIPv4Stack=true -Dstart_scheduler=false -DdeploymentSystemName=mysql
set JAVA_OPTS=%JAVA_OPTS% -DdebugMode=true
set JAVA_OPTS=%JAVA_OPTS% -Drebel.packages_include=com.glaf -Drebel.aspectj_plugin=true -Drebel.spring_plugin=true  -Drebel.resteasy_plugin=true -Drebel.mybatis_plugin=true -Drebel.jackson_plugin=true -noverify -agentpath:%CATALINA_HOME%\bin\jrebel64.dll
